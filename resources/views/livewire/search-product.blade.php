<div class="position-relative">
    ...
    <div wire:loading class="card position-absolute mt-1 border-0" style="z-index: 1040;left: 0;right: 0;">
    ...
    @if(!empty($query))
        <div wire:click="resetQuery" class="position-fixed w-100 h-100" style="left: 0; top: 0; right: 0; bottom: 0;z-index: 1030;"></div>
        ...
        @else
            <div class="card position-absolute mt-1 border-0" style="z-index: 1040;left: 0;right: 0;">
                <div class="card-body shadow">
