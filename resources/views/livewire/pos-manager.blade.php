<div>
    <!-- Tab Navigation -->
    <div class="card mb-3" wire:poll.5s="refreshTabTotals">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        <div class="card-body">
                            <livewire:search-product :active-cart-instance="$this->activeCartInstance" :key="'search-'.$activeTab" />
                        </div>
                    </div>

                    <div class="card">
                        <div class="card-body">
                            <livewire:product-cart :cart-instance="$this->activeCartInstance" :key="'cart-'.$activeTab" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <livewire:checkout-panel :cart-instance="$this->activeCartInstance" :key="'checkout-'.$activeTab" />
                </div>
            </div>
        </div>
    </div>
