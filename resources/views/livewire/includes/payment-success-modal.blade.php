    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content border-success">
            ...
            <div class="modal-header bg-success text-white">
                ...
                <button type="button" class="btn-close btn-close-white" wire:click="closePaymentSuccessModal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                    ...
                    <button type="button" class="btn btn-primary btn-lg me-md-2" wire:click="continueSellingFromModal">
