            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <x-input name="bank_name" label="Bank name" value="{{ old('bank_name', $user->bank_name) }}" />

                        <x-input name="bank_account_number" label="Bank account number" value="{{ old('bank_account_number', $user->bank_account_number) }}" />
                    </div>
